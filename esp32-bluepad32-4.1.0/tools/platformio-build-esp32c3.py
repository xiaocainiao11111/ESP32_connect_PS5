...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "bluedroid", "decoder", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "bluedroid", "encoder", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "hxcmod-player"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "hxcmod-player", "mods"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "lc3-google", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "lwip", "dhcp-server"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "md5"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "3rd-party", "yxml"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "src", "classic"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "src", "ble", "gatt-service"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "src", "ble"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "src"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "platform", "embedded"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "platform", "freertos"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "platform", "lwip"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "lwip", "lwip", "src", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "btstack", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "cmd_nvs_4.4"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "cmd_system_4.4"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "bluepad32", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "bluepad32_arduino", "include"),
